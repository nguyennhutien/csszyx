    ...
    >
      ...
      <div
        sz={{
          ...
          dark: { bg: { color: '#0d0d12', op: 80 }, borderColor: { color: 'white', op: 5 } },
          backdropBlur: 'xl',
          border: true,
      ...
      >
        ...
        <div
          sz={{
            ...
            borderB: true,
            borderColor: { color: 'black', op: 5 },
            dark: { borderColor: { color: 'white', op: 5 }, bg: { color: 'black', op: 40 } },
            flex: true,
            justify: 'between',
            items: 'center',
            px: 6,
      ...
      >
        <a
          ...
          sz={{
            ...
            bg: 'white',
            dark: {
              bg: { color: 'secondary', op: 5 },
              borderColor: { color: 'secondary', op: 50 },
              color: 'white',
              hover: { bg: 'primary', color: 'neutral-900', borderColor: 'primary' },
            },
