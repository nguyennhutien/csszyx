...
<div sz={{
  ...
  xl: { display: 'flex' },  // ≥1280px: flex layout
}} />
```
...
<div sz={{
  md: {
    maxLg: { display: 'none' },  // md:max-lg:hidden (768–1023px range)
  },
}} />
```
...
<p sz={{
  ...
  firstLine:   { textTransform: 'uppercase' },
  firstLetter: { text: '5xl', weight: 'bold', float: 'left', mr: 2 },
}} />
```
  ...
  <summary sz={{
    group: {
      aria: {
        ...
        'current=page': { weight: 'bold' }, // group-aria-[current=page]:font-bold
      },
    },
  }} />
</details>
