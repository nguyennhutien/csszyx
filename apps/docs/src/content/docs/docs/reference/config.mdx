...
interface ProductionConfig {
  ...
  mangleVars: boolean; // Opt into CSS custom property name mangling and hoisting
...
| `mangleVars`       | `false` | Opt into CSS custom property name mangling and hoisting. Disabled builds keep existing `--_sz-*` output. |
