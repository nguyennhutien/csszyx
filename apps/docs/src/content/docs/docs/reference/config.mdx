...
interface BuildConfig {
  ...
  parser?: "babel" | "oxc"; // Source parser for JSX/TSX sz transforms
...
| `parser`         | `'oxc'`                | Source parser for JSX/TSX sz transforms. Use `'babel'` only as a compatibility escape hatch if an app hits an oxc parser edge case.                                                                                |
