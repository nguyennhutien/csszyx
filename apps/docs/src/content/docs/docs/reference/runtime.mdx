...
description: _sz, _szIf, _szSwitch, _szMerge, szv() composition and variant helpers, plus splitBox, classify/has/pick/omit, and stripSzProps for nested element routing.
---
