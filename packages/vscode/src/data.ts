...
export const VALUE_SUGGESTIONS: Record<string, string[]> = {
    ...
    borderColorT: COLOR_VALUES,
    borderColorR: COLOR_VALUES,
    borderColorB: COLOR_VALUES,
    borderColorL: COLOR_VALUES,
    outlineColor: COLOR_VALUES,
    caretColor: COLOR_VALUES,
    ...
    textDecorationColor: COLOR_VALUES,
