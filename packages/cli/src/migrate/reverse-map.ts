...
// ============================================================================
export const SORTED_PREFIXES: string[] = Object.keys(REVERSE_PROPERTY_MAP)
    .sort((a, b) => {
...
// ============================================================================
export const KNOWN_BREAKPOINTS = new Set([
    'sm', 'md', 'lg', 'xl', '2xl',
]);
...
export const SPACING_PROPS = new Set([
    ...
    'm', 'mt', 'mr', 'mb', 'ml', 'mx', 'my', 'ms', 'me',
    'gap', 'gap-x', 'gap-y', 'w', 'h', 'min-w', 'max-w', 'min-h', 'max-h', 'size', 'basis',
    ...
    'scroll-ps', 'scroll-pe',
    'border-spacing', 'translate-x', 'translate-y',
]);
...
export const TEXT_ALIGN_KEYWORDS = new Set([
    'left', 'center', 'right', 'justify', 'start', 'end',
]);

export const TEXT_WRAP_KEYWORDS = new Set([
    'wrap', 'nowrap', 'balance', 'pretty',
]);

export const TEXT_OVERFLOW_KEYWORDS = new Set([
    'ellipsis', 'clip',
]);
...
export const DECORATION_THICKNESS_KEYWORDS = new Set(['auto', 'from-font', '0', '1', '2', '4', '8']);
...
const COLOR_SCALE_RE = /^(slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-\d+$/;
...
export function isColorValue(value: string): boolean {
    if (COLOR_NAMES.has(value)) {return true;}
    if (COLOR_SCALE_RE.test(value)) {return true;}
    return false;
}
...
export const KNOWN_SIMPLE_VARIANTS = new Set([
    ...
    'required', 'valid', 'invalid', 'autofill', 'open',
