 ...
 */
export function handleMigrate(input: MigrateInput): { content: Array<{ type: 'text'; text: string }> } {
        ...
        content: [
            {
                ...
                text: JSON.stringify({
                    ...
                    stats: {
                        ...
                        unrecognized: result.stats.classesUnrecognized.length > 0
                            ? result.stats.classesUnrecognized
                            : undefined,
                    },
                    warnings: result.warnings.length > 0 ? result.warnings : undefined,
                    potentiallyUnusedImports: result.potentiallyUnusedImports.length > 0
