...
export const BOX_ROLE_TOKENS: ReadonlyMap<string, BoxRoleEntry> = new Map([
    ...
    ["flex-col", { role: "inner", category: "flex" }],
    ["flex-col-reverse", { role: "inner", category: "flex" }],
    ["flex-nowrap", { role: "inner", category: "flex" }],
    ["flex-row", { role: "inner", category: "flex" }],
    ["flex-row-reverse", { role: "inner", category: "flex" }],
    ["flex-wrap", { role: "inner", category: "flex" }],
    ["flex-wrap-reverse", { role: "inner", category: "flex" }],
