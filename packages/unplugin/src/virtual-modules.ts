 ...
 * @generated
 */
import { registerMergeSignatures, registerUnservedClasses } from '@csszyx/runtime';

registerUnservedClasses(${classes === undefined ? UNSERVED_PLACEHOLDER : JSON.stringify(classes)});
registerMergeSignatures(${mergeSignatures === undefined ? MERGE_SIGNATURES_PLACEHOLDER : serializeMergeSignatures(mergeSignatures)});
`;
}
