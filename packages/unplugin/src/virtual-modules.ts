 ...
 *
 * The names are only known once every module has been transformed, but the
 ...
 */
export function createUnservedRuntimeModule(): string {
    return `/**
...
registerUnservedClasses(${UNSERVED_PLACEHOLDER});
`;
}
